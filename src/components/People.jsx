...
export const People = ({ people, setPeople }) => {
  ...
  return (
    <div>
      <h2 className='text-center my-4 text-white'>Trabajadores</h2>
      ...
      {/* Formulario */}
      <div className='container'>
        <h2 className='text-center mt-4 text-white' > {isEditing ? 'Actualizar Empleado' : 'Crear Nuevo Empleado'} </h2>
        <form>
          <div>
            <label className="text-white" htmlFor="name">Nombres</label>
          ...
          <div>
            <label className="text-white" htmlFor="img">Avatar</label>
